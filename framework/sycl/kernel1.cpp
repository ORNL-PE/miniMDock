...
/* DPCT_ORIG 	__shared__ float sFloatAccumulator;*/
        ...
        float  energy = 0.0f;
/* DPCT_ORIG 	int    run_id = blockIdx.x / cData.dockpars.pop_size;*/
        int run_id = item_ct1.get_group(2) / cData.dockpars.pop_size;
/* DPCT_ORIG 	float* pGenotype = pMem_conformations_current + blockIdx.x *
...
/* DPCT_ORIG 	if (threadIdx.x == 0)*/
        ...
        {
/* DPCT_ORIG 		pMem_energies_current[blockIdx.x] = energy;*/
                pMem_energies_current[item_ct1.get_group(2)] = energy;
/* DPCT_ORIG 		cData.pMem_evals_of_new_entities[blockIdx.x] = 1;*/
...
{
/* DPCT_ORIG 	gpu_calc_initpop_kernel<<<blocks,
 * threadsPerBlock>>>(pConformations_current, pEnergies_current);*/
        /*
        ...
        */
        dpct::get_default_queue().submit([&](sycl::handler &cgh) {
                ...
                /*
                DPCT1101:208: 'MAX_NUM_OF_ATOMS' expression was replaced with a
